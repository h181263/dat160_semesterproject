...
class WallFollowerClass(Node):
    def __init__(self):
        ...
        self.srv = self.create_service(SetBool, 'wall_follower_switch', self.wall_follower_switch_callback)
    ...
    def wall_follower_switch_callback(self, request, response):
        self.active = request.data
        response.success = True
        response.message = f"WallFollower active: {self.active}"
