...
#ifndef SCORING_INTERFACES__SRV__DETAIL__SET_MARKER_POSITION__FUNCTIONS_H_
#define SCORING_INTERFACES__SRV__DETAIL__SET_MARKER_POSITION__FUNCTIONS_H_
...
#include "scoring_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "scoring_interfaces/srv/detail/set_marker_position__struct.h"

/// Initialize srv/SetMarkerPosition message.
/**
...
/// Create srv/SetMarkerPosition message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * scoring_interfaces__srv__SetMarkerPosition_Request__init().
...
/// Destroy srv/SetMarkerPosition message.
/**
 * It calls
 * scoring_interfaces__srv__SetMarkerPosition_Request__fini()
...
/// Check for srv/SetMarkerPosition message equality.
/**
...
/// Copy a srv/SetMarkerPosition message.
/**
...
/// Initialize array of srv/SetMarkerPosition messages.
/**
...
/// Finalize array of srv/SetMarkerPosition messages.
/**
 * It calls
 * scoring_interfaces__srv__SetMarkerPosition_Request__fini()
...
/// Create array of srv/SetMarkerPosition messages.
/**
 * It allocates the memory for the array and calls
 * scoring_interfaces__srv__SetMarkerPosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetMarkerPosition messages.
/**
 * It calls
 * scoring_interfaces__srv__SetMarkerPosition_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetMarkerPosition message array equality.
/**
...
/// Copy an array of srv/SetMarkerPosition messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * scoring_interfaces__srv__SetMarkerPosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scoring_interfaces
...
/**
 * It calls
 * scoring_interfaces__srv__SetMarkerPosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_scoring_interfaces
...
/**
 * It allocates the memory for the array and calls
 * scoring_interfaces__srv__SetMarkerPosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scoring_interfaces
...
/**
 * It calls
 * scoring_interfaces__srv__SetMarkerPosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SCORING_INTERFACES__SRV__DETAIL__SET_MARKER_POSITION__FUNCTIONS_H_
