...
class Metaclass_GoToPoint_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('bug2_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GoToPoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bug2_interfaces.srv import _go_to_point
...
class GoToPoint(metaclass=Metaclass_GoToPoint):
    from bug2_interfaces.srv._go_to_point import GoToPoint_Request as Request
    from bug2_interfaces.srv._go_to_point import GoToPoint_Response as Response
