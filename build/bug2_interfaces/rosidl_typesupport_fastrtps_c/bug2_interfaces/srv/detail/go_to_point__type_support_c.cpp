...
#include "bug2_interfaces/srv/detail/go_to_point__rosidl_typesupport_fastrtps_c.h"
...
#include "bug2_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_bug2_interfaces
...
using _GoToPoint_Request__ros_msg_type = bug2_interfaces__srv__GoToPoint_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bug2_interfaces
size_t get_serialized_size_bug2_interfaces__srv__GoToPoint_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPoint_Request__ros_msg_type * ros_message = static_cast<const _GoToPoint_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GoToPoint_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bug2_interfaces__srv__GoToPoint_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bug2_interfaces
size_t max_serialized_size_bug2_interfaces__srv__GoToPoint_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_bug2_interfaces__srv__GoToPoint_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bug2_interfaces, srv, GoToPoint_Request)() {
...
using _GoToPoint_Response__ros_msg_type = bug2_interfaces__srv__GoToPoint_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bug2_interfaces
size_t get_serialized_size_bug2_interfaces__srv__GoToPoint_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPoint_Response__ros_msg_type * ros_message = static_cast<const _GoToPoint_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_bug2_interfaces__srv__GoToPoint_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bug2_interfaces
size_t max_serialized_size_bug2_interfaces__srv__GoToPoint_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_bug2_interfaces__srv__GoToPoint_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bug2_interfaces, srv, GoToPoint_Response)() {
...
// already included above
// #include "bug2_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "bug2_interfaces/srv/go_to_point.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bug2_interfaces, srv, GoToPoint)() {
