...
static const _GoToPoint_Request_type_support_symbol_names_t _GoToPoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bug2_interfaces, srv, GoToPoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bug2_interfaces, srv, GoToPoint_Request)),
  }
};
...
{
  return &::bug2_interfaces::srv::rosidl_typesupport_cpp::GoToPoint_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bug2_interfaces, srv, GoToPoint_Request)() {
  return get_message_type_support_handle<bug2_interfaces::srv::GoToPoint_Request>();
}
...
static const _GoToPoint_Response_type_support_symbol_names_t _GoToPoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bug2_interfaces, srv, GoToPoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bug2_interfaces, srv, GoToPoint_Response)),
  }
};
...
{
  return &::bug2_interfaces::srv::rosidl_typesupport_cpp::GoToPoint_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bug2_interfaces, srv, GoToPoint_Response)() {
  return get_message_type_support_handle<bug2_interfaces::srv::GoToPoint_Response>();
}
...
static const _GoToPoint_type_support_symbol_names_t _GoToPoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bug2_interfaces, srv, GoToPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bug2_interfaces, srv, GoToPoint)),
  }
};
...
{
  return &::bug2_interfaces::srv::rosidl_typesupport_cpp::GoToPoint_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, bug2_interfaces, srv, GoToPoint)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<bug2_interfaces::srv::GoToPoint>();
}
