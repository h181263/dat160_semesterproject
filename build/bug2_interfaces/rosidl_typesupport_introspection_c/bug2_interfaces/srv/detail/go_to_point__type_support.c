...
#include <stddef.h>
#include "bug2_interfaces/srv/detail/go_to_point__rosidl_typesupport_introspection_c.h"
#include "bug2_interfaces/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  bug2_interfaces__srv__GoToPoint_Request__init(message_memory);
}

void GoToPoint_Request__rosidl_typesupport_introspection_c__GoToPoint_Request_fini_function(void * message_memory)
{
  bug2_interfaces__srv__GoToPoint_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GoToPoint_Request__rosidl_typesupport_introspection_c__GoToPoint_Request_message_member_array[2] = {
  {
    ...
    offsetof(bug2_interfaces__srv__GoToPoint_Request, move_switch),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bug2_interfaces__srv__GoToPoint_Request, target_position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GoToPoint_Request__rosidl_typesupport_introspection_c__GoToPoint_Request_message_members = {
  "bug2_interfaces__srv",  // message namespace
  "GoToPoint_Request",  // message name
  2,  // number of fields
  sizeof(bug2_interfaces__srv__GoToPoint_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_bug2_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bug2_interfaces, srv, GoToPoint_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  bug2_interfaces__srv__GoToPoint_Response__init(message_memory);
}

void GoToPoint_Response__rosidl_typesupport_introspection_c__GoToPoint_Response_fini_function(void * message_memory)
{
  bug2_interfaces__srv__GoToPoint_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GoToPoint_Response__rosidl_typesupport_introspection_c__GoToPoint_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bug2_interfaces__srv__GoToPoint_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GoToPoint_Response__rosidl_typesupport_introspection_c__GoToPoint_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(bug2_interfaces__srv__GoToPoint_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_bug2_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bug2_interfaces, srv, GoToPoint_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_service_members = {
  "bug2_interfaces__srv",  // service namespace
  "GoToPoint",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_Request_message_type_support_handle,
  NULL  // response message
  // bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_Response_message_type_support_handle
};

static rosidl_service_type_support_t bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_service_type_support_handle = {
  0,
  &bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bug2_interfaces, srv, GoToPoint)() {
  if (!bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_service_type_support_handle.typesupport_identifier) {
    bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bug2_interfaces, srv, GoToPoint_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bug2_interfaces, srv, GoToPoint_Response)()->data;
  }

  return &bug2_interfaces__srv__detail__go_to_point__rosidl_typesupport_introspection_c__GoToPoint_service_type_support_handle;
}
